package lk.server.cocktails.feachers.init.controller;

import com.google.gson.Gson;
import com.google.gson.reflect.TypeToken;
import lk.utils.files.FileManager;
import lk.server.cocktails.customtypes.locale.Locale;
import lk.server.cocktails.feachers.init.dto.CocktailFileStructure;
import lk.server.cocktails.feachers.init.dto.IngredientFileStructure;
import lk.server.cocktails.feachers.init.dto.IngredientStructure;
import lk.server.cocktails.feachers.init.dto.help.SavedCocktailsDto;
import lk.server.cocktails.feachers.init.dto.help.SavedCocktailsDto2;
import lk.server.cocktails.feachers.cocktail.entities.*;
import lk.server.cocktails.feachers.cocktail.services.CocktailService;
...
import lk.server.cocktails.feachers.mix.service.MixCocktailService;
...
public class InitCocktailController {
    ...
    private List<SavedCocktailsDto> readCocktails() throws IOException {
        ...
        Type type = new TypeToken<List<CocktailFileStructure>>() {}.getType();
    ...
    private Map<String, Long> readIngredients() throws IOException {
        ...
        Type type = new TypeToken<List<IngredientFileStructure>>() {}.getType();
